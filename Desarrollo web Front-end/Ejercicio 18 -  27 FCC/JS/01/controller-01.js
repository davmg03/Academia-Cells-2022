/* El controlador solo alerta al usuario cada vez que presiona una tecla, pero también 
   define la clase ButtonInput, que se usa para rastrear los estados de los botones. */
let Controller = function() {
    ...
    this.keyDownUp = function(event) { 
      ...
      alert("Presionate una tecla (" + event.keyCode + ")!");
    };
