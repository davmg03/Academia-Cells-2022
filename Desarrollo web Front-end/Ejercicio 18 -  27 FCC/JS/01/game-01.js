/* Para evitar que este nivel parezca demasiado aburrido, se hizo ¿ la lógica del juego gradualmente.
cambiando algunos valores de color que luego se dibujan en el lienzo de visualización en el bucle. */
let Game = function() {
