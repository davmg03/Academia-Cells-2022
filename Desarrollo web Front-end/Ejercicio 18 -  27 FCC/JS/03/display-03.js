/* Se mueven algunas funciones genéricas a Display.prototype.
Se crea la clase Display.TileSheet, que maneja la imagen de la hoja de mosaico y su
dimensiones.
Desechamos la función drawRectangle y se reemplaza con la función drawPlayer. */
let Display = function(canvas) {
    this.buffer  = document.createElement("canvas").getContext("2d"),
    this.context = canvas.getContext("2d");
    this.tile_sheet = new Display.TileSheet(16, 8);
    /* Esta funcion draws del mapa del buffer. */
