/* Cambios:
1. Se eliminó la clase TileSheet de la parte 3 y se agregó la clase Game.World.TileSet a Game.
2. Cambió la función dibujarMapa para que sea lo más genérica posible.
3. Cambió la función dibujarJugador a la función dibujarObjeto. */
