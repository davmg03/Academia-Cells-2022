/* Cambios desde la parte 6:
  1. Se agregó la matriz de zanahorias al archivo de zona.
  2. Se movió el método collideObject fuera de Game.Door y dentro de Game.Object.
  3. Cambió el nombre de collideObject a collideObjectCenter y creó una nueva función collideObject para la detección de colisiones rectangulares.
  4. Se agregaron las clases Game.Carrot y Game.Grass.
  5. Se agregaron marcos para zanahorias y pasto al juego de mosaicos.
  6. Hizo un pequeño cambio en el constructor de Game.Animator.
  7. Se agregó carrot_count para contar zanahorias.
  8. Se agregó la matriz de césped al archivo de zona. También reflejado en Game.World*/
let Game = function() {
  ...
  // Hizo el tipo de animación predeterminado "bucle":
  ...
  Game.Collider = function() {
    /* Cambié esto para que todas las comprobaciones se realicen en primer orden. */
  ...
  // Se agregaron valores predeterminados de 0 para offset_x y offset_y
  ...
  Game.Object.prototype = {
    ...
    /* Ahora hace detección de colisión rectangular. */
  ...
  /* Se agrego setCenterX, setCenterY, getCenterX y getCenterY*/
  ...
  Game.World.prototype = {
    ...
    collideObject:function(object) {
      /* Se desecho la colisión del límite mundial. Ahora le toca a las fichas mantener
